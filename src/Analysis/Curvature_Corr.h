#if !defined(AFX_Curvature_Corr_H_7F4B21B8_C13C_5648_BF23_124095086234__INCLUDED_)
#define AFX_Curvature_Corr_H_7F4B21B8_C13C_5648_BF23_124095086234__INCLUDED_
...
class Curvature_Corr
{
public:
    
	Curvature_Corr(Argument *pArgu);
	virtual ~Curvature_Corr();
