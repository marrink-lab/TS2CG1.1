...
TwoLipid_Distribution::TwoLipid_Distribution(Argument *pArgu)
{
...
std::cout<<"\n";
std::cout<<"------------- TwoLipid_Distribution is running: Which mean your inputs were ok, but let see if its make sense too  -------------"<<"\n";
...
TwoLipid_Distribution::~TwoLipid_Distribution()
{
    
}
std::vector<double> TwoLipid_Distribution::FindCurv (bead *p)
{
    std::vector<double> C;
    double dist2 = 20000;
    int i=0;
...
double TwoLipid_Distribution::dist2between2bead(bead* b1,bead* b2)
{
